...
public class FileStruct implements Cloneable {
     ...
     *
     * @param filePath the file path to insert into the file structure
    ...
    /**
     * @param filePath path to the target FileStruct to be returned
